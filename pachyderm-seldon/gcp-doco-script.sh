#!/bin/bash
#From:https://docs.pachyderm.com/2.4.x/getting-started/cloud-deploy/gcp/
#From:https://github.com/pachyderm/pachyderm/blob/master/etc/deploy/gcp/gcp-doco-script.sh
...
gsutil mb -l ${GCP_REGION} gs://${NAME}-data
gsutil mb -l ${GCP_REGION} gs://${NAME}-detector
